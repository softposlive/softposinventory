...
public class Jdi_browse_htranin extends javax.swing.JDialog {
    
    /** Creates new form ShowDialog */
    public Jdi_browse_htranin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTableShow();
    ...
    private void initComponents() {
        ...
        setTitle("แสดงรายการใบรับโอนสินค้า (เข้า) จากสาขาที่ยังไม่ได้บันทึกตัดสต็อก");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_browse_htranin dialog = new Jdi_browse_htranin(new javax.swing.JFrame(), true);
    ...
    private void loadDataToGrid() {
        ...
        try {
            hr = new Db_htranin();
            sql = "SELECT * FROM htranin WHERE r_post = 'N' Order by r_date desc";
