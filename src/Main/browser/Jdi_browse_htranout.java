...
public class Jdi_browse_htranout extends javax.swing.JDialog {
    
    /** Creates new form ShowDialog */
    public Jdi_browse_htranout(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setTitle("แสดงรายการใบรับโอนสินค้า (ออก) จากสาขาที่ยังไม่ได้บันทึกตัดสต็อก");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_browse_htranout dialog = new Jdi_browse_htranout(new javax.swing.JFrame(), true);
    ...
    private void loadDataToGrid() {
        ...
        try {
            hr = new Db_htranout();
            sql = "SELECT * FROM htranout WHERE r_post = 'N' Order by r_date desc";
            ...
            if (rs != null) {
                ...
                while (rs.next()){    
                    ...
                    row[3] = loadDetailCount(rs.getString("r_no"));
