...
public class Jdi_browse_factory extends javax.swing.JDialog {

    /** Creates new form FactoryShowDialog */
    public Jdi_browse_factory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTableShow();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_browse_factory dialog = new Jdi_browse_factory(new javax.swing.JFrame(), true);
    ...
    private void loadDataToGrid() {
        try {
            ...
            while (rs.next()){    
                ...
                row[1] = ThaiUtil.ASCII2Unicode(rs.getString("factoryname"));   
                model.addRow(row);
            }
