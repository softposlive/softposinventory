...
public class Jdi_browse_hprolost extends javax.swing.JDialog {
    
    /** Creates new form ShowDialog */
    public Jdi_browse_hprolost(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_browse_hprolost dialog = new Jdi_browse_hprolost(new javax.swing.JFrame(), true);
    ...
    private void loadDataToGrid() {
        ...
        try {
            hr = new Db_hprolost();
            sql = "SELECT * FROM hprolost WHERE r_post = 'N' Order by r_date desc";
