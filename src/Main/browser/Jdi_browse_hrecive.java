...
public class Jdi_browse_hrecive extends javax.swing.JDialog {
    
    /** Creates new form ShowDialog */
    public Jdi_browse_hrecive(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTableShow();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_browse_hrecive dialog = new Jdi_browse_hrecive(new javax.swing.JFrame(), true);
    ...
    private void loadDataToGrid() {        
        ...
        try {
            hr = new Db_hrecive();
            sql = "SELECT * FROM hrecive WHERE r_post = 'N' Order by r_date desc";
