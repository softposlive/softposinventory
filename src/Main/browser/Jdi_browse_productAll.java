...
public class Jdi_browse_productAll extends javax.swing.JDialog {
    Frame parent;
    /** Creates new form ShowDialog */
    public Jdi_browse_productAll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTableShow();
        this.parent = parent;
    ...
    public Jdi_browse_productAll(java.awt.Frame parent, boolean modal,boolean b) {
        super(parent, modal);
        initComponents();
        setTableShow();
    ...
    private void initComponents() {
        ...
        tblShow.setFont(new java.awt.Font("Norasi", 0, 14));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_browse_productAll dialog = new Jdi_browse_productAll(new javax.swing.JFrame(), true);
    ...
    private void setTableShow() {
        ...
        int[] colSize = {70, 250, 60, 75, 90,60,70,70,90,90,90,90,90,90};
        tblShow.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private String getSQL(String sort){
        return "SELECT * FROM product Order by "+sort;
    }
