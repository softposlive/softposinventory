...
public class SaveCostDialog extends javax.swing.JDialog {

    public SaveCostDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("รายการบันทึกค่าใช้จ่าย");
        setResizable(false);
        ...
        jMenuItem4.setText("ลบข้อมูล (Delete)");
        ...
        jMenuItem6.setText("จบการทำงาน (Exit)");
        ...
        jMenuItem7.setText("สรุปรายการค่าใช้จ่ายตามรหัสค่าใช้จ่าย");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SaveCostDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SaveCostDialog dialog = new SaveCostDialog(new javax.swing.JFrame(), true);
