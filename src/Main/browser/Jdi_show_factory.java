...
public class Jdi_show_factory extends javax.swing.JDialog {

    /** Creates new form FactoryShowDialog */
    public Jdi_show_factory(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTableShow();
    ...
    private void initComponents() {
        ...
        setTitle("แสดงรายการโรงงาน (ที่จัดส่ง)");
...
private void tblShowMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblShowMouseClicked
    if(evt.getClickCount()==2){
        ...
        FactoryControl hr = null;
            try {
                hr = new FactoryControl();
...
private void jButton1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseReleased
    int index = tblShow.getSelectedRow();
    FactoryControl hr = new FactoryControl();
    dataRecord = hr.getRecordAt((String) tblShow.getValueAt(index, 0));
    dispose();
...
this.dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_show_factory dialog = new Jdi_show_factory(new javax.swing.JFrame(), true);
 ...
 private FactoryBean dataRecord;

    public FactoryBean getDataRecord() {
        return dataRecord;
    }
