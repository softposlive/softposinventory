 ...
 * @author softpos
 */
public class Report_In extends javax.swing.JDialog {

    /**
     * Creates new form Report_In
     */
    public Report_In(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("สรุปยอดการใช้วัตถุดิบ (By PLU)");
        ...
        jPanel2.getAccessibleContext().setAccessibleName("กำหนดวันที่ (Date)");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "กลุ่ม", "รหัสสินค้า (PLU)", "ชื่อสินค้า (Description)", "ราคา/หน่วย", "จำนวนที่ใช้", "หน่วยนับ", "จำนวนเงิน"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.Double.class, java.lang.Integer.class, java.lang.String.class, java.lang.Double.class
            };
        ...
        setSize(new java.awt.Dimension(1024, 746));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Report_In.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Report_In dialog = new Report_In(new javax.swing.JFrame(), true);
