...
public class Jdi_report_prolost extends javax.swing.JDialog {

    /** Creates new form Jdi_report_recive */
    public Jdi_report_prolost(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("แสดงรายการบันทึกรายการของเสีย & ชำรุด");
        ...
        tblHeader.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "วันที่ (Date)", "เลขที่เอกสาร", "", "", "หมายเหตุ", "จำนวนรายการ", "เข้าสต็อก", "วันที่ POST", "เวลา POST", "พนักงาน"
            }
        ) {
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    ...
    snp.prolostPrintReport(txt1.getText().trim(), txt2.getText().trim(), chk1.isSelected(), true);
...
private void btn_exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_exitActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Jdi_report_prolost dialog = new Jdi_report_prolost(new javax.swing.JFrame(), true);
    ...
    private void setTableHeader() {
        ...
        int[] colSize = {90, 130, 180, 70, 250, 110, 70, 90, 90, 100};
        tblHeader.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void setTableDetail() {
        ...
        TableColumn column = null;
        int[] colSize = {50, 100, 250, 50, 80, 80, 80, 80, 80, 80, 70};
        tblDetail.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        for (int i = 0; i < colSize.length; i++) {
    ...
    private void loadDetail(String text) {
        ...
        String sql = "SELECT r.*, p.* FROM prolost r, product p WHERE (r.r_pcode = p.pcode) AND r.r_no = '" + text + "'";
    ...
    private ResultSet getRecordHeader(Calendar date1, Calendar date2) {
        String sql = "SELECT * FROM hprolost WHERE (r_date BETWEEN '" + dateFmtSql.format(date1.getTime()) + "' AND '" + dateFmtSql.format(date2.getTime()) + "')";
