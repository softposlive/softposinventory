...
public class Jdi_Inv_productAll extends javax.swing.JDialog {
    ...
    public Jdi_Inv_productAll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void bntShowMemberAllClick() {
        int LineCnt = 1 ;
        try { 
            Statement stmt = (Statement) MySQLConnect.getStatement();
            String LoadTableFile = "select *from product where pactive='Y' order by pgroup,pcode ";
    ...
    public void ShowMemberByCode() {
        ...
        try { 
            Statement stmt = (Statement) MySQLConnect.getStatement();
            String LoadTableFile = "select *from product where (pactive='Y') and (pcode like '"+TempStr+"') order by pcode";
            ResultSet rec = stmt.executeQuery(LoadTableFile);
            Date dt = new Date();
            ClearGrid() ;
            rec.first();
    ...
    public void ShowMemberByName() {
        ...
        try { 
            ...
            String LoadTableFile = "select *from product where (pactive='Y') and (pdesc like '"+TempStr+"') order by pdesc";
            ResultSet rec = stmt.executeQuery(LoadTableFile);
            Date dt = new Date();
            ClearGrid() ;
            rec.first();
    ...
    public void ShowMemberByTel() {
        ...
        try { 
            Statement stmt = (Statement) MySQLConnect.con.createStatement();
            String LoadTableFile = "select *from product where (pactive='Y') and (pgroup like '"+TempStr+"') order by pdesc";
            ResultSet rec = stmt.executeQuery(LoadTableFile);
            Date dt = new Date();
            ClearGrid() ;
            rec.first();
...
public Product getDataRecord() {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Jdi_Inv_productAll dialog = new Jdi_Inv_productAll(new javax.swing.JFrame(), true);
