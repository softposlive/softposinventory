 ...
 * @author  root
 */
public class Jdi_report_sumTranoutGroup extends javax.swing.JDialog {
 
    /** Creates new form Jdi_report_recive */
    public Jdi_report_sumTranoutGroup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("สรุปการโอนสินค้า (ออก) ตามแผนกสินค้า");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPcode2, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 965, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cmdPrint, javax.swing.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jTabbedPane1.addTab("สรุปรายการโอนสินค้า (ออก) ตามแผนกสินค้า (รวมทั้งหมด)", jPanel4);
        ...
        tblPage2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "สาขา", "ชื่อสาขา (Branch Name)", "แผนก", "ชื่อแผนก", "รหัสสินค้า", "ชื่อสินค้า/รายการ", "จำนวน", "หน่วยนับ", "จำนวนเงิน", ""
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPane3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 965, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cmdPrint1, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jTabbedPane1.addTab("สรุปรายการโอนสินค้า (ออก) ตามแผนกสินค้า (แยกตามสาขา)", jPanel5);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTabbedPane1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1001, Short.MAX_VALUE)
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    report.sumTranoutGroup1PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
...
private void cmdPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrint1ActionPerformed
    report.sumTranoutGroup2PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_report_sumTranoutGroup dialog = new Jdi_report_sumTranoutGroup(new javax.swing.JFrame(), true);
    ...
    private void setTableHeaderBran(){
       ...
       TableColumn column = null;
        int[] colSize = {50,150, 80,150,110,200,80,65,80,10};
        tblPage2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        for (int i = 0; i < colSize.length; i++) {
    ...
    private ResultSet getRecordHeaderAll(Calendar date1, Calendar date2, String pgroup1 , String pgroup2, String pbran1,String pbran2)  {
        String sql = "SELECT TranOut.R_PCode, SUM( TranOut.R_Qty ), SUM( TranOut.R_Amount ),TranOut.r_unit, TranOut.R_No, HtranOut.R_No, HtranOut.R_Date, HtranOut.R_Bran, Product.PCode, Product.PGroup ,Product.pdesc,Product.punit1" +
