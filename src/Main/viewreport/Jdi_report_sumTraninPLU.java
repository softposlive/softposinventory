 ...
 * @author  root
 */
public class Jdi_report_sumTraninPLU extends javax.swing.JDialog {
 
    /** Creates new form Jdi_report_recive */
    public Jdi_report_sumTraninPLU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("สรุปการโอนสินค้า (เข้า) ตามรหัสสินค้า");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(txtPcode1, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmdProductChoose3, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPcode2, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("สรุปรายการโอนสินค้า (เข้า) ตามรหัสสินค้า (รวมทั้งหมด)", jPanel4);
        ...
        tblPage2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสสาขา", "ชื่อสาขา (Branch Name)", "รหัสสินค้า", "ชื่อสินค้า/รายการ", "จำนวน", "หน่วยนับ", "จำนวนเงิน", ""
            }
        ) {
            boolean[] canEdit = new boolean [] {
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addComponent(cmdPrint1, javax.swing.GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jTabbedPane1.addTab("สรุปรายการโอนสินค้า (เข้า) ตามรหัสสินค้า (แยกตามสาขา)", jPanel5);
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    report.sumTraninPLU1PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
...
private void cmdPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrint1ActionPerformed
    report.sumTraninPLU2PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_report_sumTraninPLU dialog = new Jdi_report_sumTraninPLU(new javax.swing.JFrame(), true);
    ...
    private ResultSet getRecordHeaderBran(Calendar date1, Calendar date2, String pcode1 , String pcode2, String pbran1,String pbran2)  {
        String sql = "SELECT Tranin.R_PCode, SUM( Tranin.R_Qty ), SUM( Tranin.R_Amount ), Tranin.R_No, Tranin.R_Que, Tranin.R_Post, Tranin.R_Unit, Htranin.R_No, Htranin.R_Date,Htranin.R_Bran, Htranin.R_Post " +
                    //",product.pdesc,product.punit1,branfile.code,branfile.name" +
                    " FROM tranin Tranin left JOIN htranin Htranin ON  (Tranin.R_No = Htranin.R_No)" +
                    //" inner JOIN product ON (Tranin.r_pcode = product.pcode)" +
                    //" inner JOIN branfile ON (Htranin.R_Bran = branfile.code) " +
                    " WHERE  (Tranin.R_Post = 'Y') and " +
                    " (Htranin.R_Date>='"+Format.dateFmtSql.format(date1.getTime())+"') and (Htranin.R_Date<='"+Format.dateFmtSql.format(date2.getTime())+"') and" +
                    " (Tranin.R_PCode>='"+pcode1+"') and (Tranin.R_PCode<='"+pcode2+"') and " +
                    " (Htranin.R_Bran>='"+pbran1+"') and (Htranin.R_Bran<='"+pbran2+"')" +
                    " GROUP BY Tranin.R_PCode, Htranin.R_Bran" +
                    " ORDER BY Htranin.R_Bran, Tranin.R_PCode";
        try {
            System.out.println("Header := "+sql);
        ...
        if(rs!=null){
            ...
            try {
                while (rs.next()) {
                    ...
                    row[4] = Format.qtyFmt.format(rs.getDouble("SUM( Tranin.R_Qty )"));
                    row[5] = rs.getString("r_unit") ;
                    row[6] = Format.doubleFmt.format(rs.getFloat("SUM( Tranin.R_Amount )"));
                    
                    modelHeaderBran.addRow(row);
                    double qty = rs.getDouble("SUM( Tranin.R_Qty )");
                    sumQty += qty;
                    BigDecimal amt = new BigDecimal(String.valueOf(rs.getFloat("SUM( Tranin.R_Amount )")));
                    sumAmt = sumAmt.add(amt);
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this,ex);
