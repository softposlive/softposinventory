 ...
 * @author  root
 */
public class Jdi_report_sumProlostPLU extends javax.swing.JDialog {
 
    /** Creates new form Jdi_report_recive */
    public Jdi_report_sumProlostPLU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("สรุปการบันทึกรายการของเสีย & สินค้าชำรุด ตามรหัสสินค้า");
        ...
        jTabbedPane1.addTab("สรุปรายการบันทึกรายการของเสีย & สินค้าชำรุด ตามรหัสสินค้า (รวมทั้งหมด)", jPanel4);
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    report.sumProlostPLU1PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_report_sumProlostPLU dialog = new Jdi_report_sumProlostPLU(new javax.swing.JFrame(), true);
    ...
    private ResultSet getRecordHeader(Calendar date1, Calendar date2)  {
        ...
        String sql = "SELECT c.r_pcode ,p.pdesc,p.punit1, SUM( c.R_Qty ) as sum1, SUM( c.R_Amount ) as sum2" +
    ...
    private void loadDetail(String text){
        resetTableModel(modelDetail);
        String sql = "select * from hprolost h inner join prolost c on c.r_no = h.r_no where (r_date between '"+Format.dateFmtSql.format(date1.getTime())+"' and '"+Format.dateFmtSql.format(date2.getTime())+"') and c.r_pcode ='"+text+"'";
        ...
        try {
            ...
            while(rs.next()){
                ...
                row[3] = Format.integerFmt.format(rs.getInt("r_qty"));
