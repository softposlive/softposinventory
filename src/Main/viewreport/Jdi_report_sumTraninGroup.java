 ...
 * @author  root
 */
public class Jdi_report_sumTraninGroup extends javax.swing.JDialog {
 
    /** Creates new form Jdi_report_recive */
    public Jdi_report_sumTraninGroup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("สรุปการโอนสินค้า (เข้า) ตามแผนกสินค้า");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addComponent(txtPcode1, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmdProductChoose3, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtPcode2, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tblHeader.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "แผนก", "ชื่อแผนก", "รหัสสินค้า", "ชื่อสินค้า/รายการ", "จำนวน", "หน่วยนับ", "จำนวนเงิน", ""
            }
        ) {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 961, Short.MAX_VALUE)
        ...
        jTabbedPane1.addTab("สรุปรายการโอนสินค้า (เข้า) ตามแผนกสินค้า (รวมทั้งหมด)", jPanel4);
        ...
        tblPage2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "สาขา", "ชื่อสาขา (Branch Name)", "แผนก", "ชื่อแผนก", "รหัสสินค้า", "ชื่อสินค้า/รายการ", "จำนวน", "null", "จำนวนเงิน", ""
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPane3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 961, Short.MAX_VALUE)
        ...
        jTabbedPane1.addTab("สรุปรายการโอนสินค้า (เข้า) ตามแผนกสินค้า (แยกตามสาขา)", jPanel5);
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    report.sumTraninGroup1PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
...
private void cmdPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrint1ActionPerformed
    report.sumTraninGroup2PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_report_sumTraninGroup dialog = new Jdi_report_sumTraninGroup(new javax.swing.JFrame(), true);
    ...
    private void setTableHeaderBran(){
        ...
        TableColumn column = null;
        int[] colSize = {80,150, 80,150,80,200,80,65,80,10};
        tblPage2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        for (int i = 0; i < colSize.length; i++) {
    ...
    private ResultSet getRecordHeaderAll(Calendar date1, Calendar date2, String pgroup1 , String pgroup2, String pbran1,String pbran2)  {
        String sql = "SELECT TranOut.R_PCode, SUM( TranOut.R_Qty ), SUM( TranOut.R_Amount ), TranOut.R_No, HtranOut.R_No, HtranOut.R_Date, HtranOut.R_Bran, Product.PCode, Product.PGroup " +
                ",Product.pdesc,Product.punit1" +
                    " FROM tranin TranOut left JOIN htranin HtranOut " +
    ...
    private ResultSet getRecordHeaderBran(Calendar date1, Calendar date2, String pgroup1 , String pgroup2, String pbran1,String pbran2)  {
        String sql = "SELECT TranOut.R_PCode, SUM( TranOut.R_Qty ), SUM( TranOut.R_Amount ), TranOut.R_No,TranOut.r_unit, HtranOut.R_No, HtranOut.R_Date, HtranOut.R_Bran, Product.PCode, Product.PGroup " +
                ",Product.pdesc,Product.punit1" +
                    " FROM tranin TranOut left JOIN htranin HtranOut " +
                    " ON  (TranOut.R_No = HtranOut.R_No)" +
                    " left JOIN product Product " +
        ...
        if (rs != null) {
            ...
            try {
                while (rs.next()) {
                    ...
                    row[3] = PUtility.SeekGroupName(rs.getString("PGroup"));
                    row[4] = rs.getString("R_PCode");
