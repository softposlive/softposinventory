...
public class Jdi_report_sumChargeGroup extends javax.swing.JDialog {
 
    public Jdi_report_sumChargeGroup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("สรุปการบันทึกรายการแจกฟรี (Charge) ตามแผนกสินค้า");
        ...
        jTabbedPane1.addTab("สรุปรายการบันทึกรายการแจกฟรี (Charge) ตามแผนกสินค้า (รวมทั้งหมด)", jPanel4);
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    report.sumChargeGroup1PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_report_sumChargeGroup dialog = new Jdi_report_sumChargeGroup(new javax.swing.JFrame(), true);
    ...
    private ResultSet getRecordHeader(Calendar date1, Calendar date2)  {
        ...
        String sql = "SELECT c.R_PCode AS cr_pcode,p.pdesc, SUM( c.R_Qty ) AS sum1, SUM( c.R_Amount ) AS sum2 , g.groupname ,p.pgroup,p.punit1" +
                " FROM charge c inner join hcharge h on c.r_no = h.r_no " +
                " inner join product p on c.r_pcode = p.pcode" +
