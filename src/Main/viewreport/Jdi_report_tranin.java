 ...
 * @author  root
 */
public class Jdi_report_tranin extends javax.swing.JDialog {

    /** Creates new form Jdi_report_recive */
    public Jdi_report_tranin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("แสดงรายการรับโอนสินค้า (เข้า) จากสาขา");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1013, Short.MAX_VALUE)
                    ...
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1013, Short.MAX_VALUE)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 1013, Short.MAX_VALUE))
                .addContainerGap())
        );
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    ...
    snp.traninPrintReport(txt1.getText().trim(), txt2.getText().trim(),
            txt3.getText().trim(), txt4.getText().trim(), chk1.isSelected(), true);
...
if (evt.getKeyCode() == KeyEvent.VK_UP || evt.getKeyCode() == KeyEvent.VK_DOWN) {//GEN-LAST:event_tblHeaderKeyReleased
        int index = tblHeader.getSelectedRow();
        String text = (String) tblHeader.getValueAt(index, 1);
        loadDetail(text);
    }
...
private void btn_exitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_exitActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Jdi_report_tranin dialog = new Jdi_report_tranin(new javax.swing.JFrame(), true);
    ...
    private void setTableHeader() {
        ...
        int[] colSize = {90, 120, 140, 50, 240, 60, 60, 75, 75, 70};
        tblHeader.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void loadDetail(String text) {
        resetTableModel(modelDetail);
        Double total = 0.0;
        String sql = "SELECT r.*, p.* FROM tranin r, product p WHERE (r.r_pcode = p.pcode) AND r.r_no = '" + text + "'";
        try {
    ...
    private ResultSet getRecordHeader(Calendar date1, Calendar date2, String fac1, String fac2) {
        String sql = "SELECT distinct(code),r_no,r_date,name,r_remark,r_total,r_userpost,R_PostTime,r_postdate,r_user,R_Post " +
                " FROM htranin h left join branfile f on h.r_bran = f.code  " +
                " WHERE (r_date BETWEEN '" + dateFmtSql.format(date1.getTime()) + "' AND '" + dateFmtSql.format(date2.getTime()) + "')";
