...
public class Jdi_report_adjstock extends javax.swing.JDialog {

    /** Creates new form Jdi_report_recive */
    public Jdi_report_adjstock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("แสดงรายการใบตรวจนับสินค้า");
        ...
        cmdPrint.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        ...
        chk1.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        chk1.setText("แสดงรายละเอียดในรายงาน");

        cmdExit.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(chk1, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(102, 102, 102)
                        .addComponent(cmdPrint, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tblHeader.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "วันที่ (Date)", "เลขที่เอกสาร", "คลัง", "หมายเหตุ", "รายการ", "ผู้บันทึก", "เข้าสต็อก", "วันที่ POST", "เวลา POST", "พนักงาน"
            }
        ) {
        ...
        tblDetail.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ลำดับ", "รหัสสินค้า (PLU Code)", "ชื่อสินค้า/รายการ", "จากเครื่อง", "นับได้จริง", "ปรับยอด", "ราคา/หน่วย", "ผู้บันทึก", "เวลาบันทึก", "วันที่บันทึก", "หมายเหตุ"
            }
        ) {
            boolean[] canEdit = new boolean [] {
...
private void cmdExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExitActionPerformed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Jdi_report_adjstock dialog = new Jdi_report_adjstock(new javax.swing.JFrame(), true);
    ...
    private void setTableHeader() {
        ...
        int[] colSize = {90, 130, 60, 240, 90, 90, 60, 80, 80, 80};
        tblHeader.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void setTableDetail() {
        ...
        TableColumn column = null;
        int[] colSize = {50, 100, 200, 80, 80, 90, 80, 80, 80, 80, 300};
        tblDetail.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        for (int i = 0; i < colSize.length; i++) {
    ...
    private void loadDetail(String text) {
        resetTableModel(modelDetail);
        String sql = "SELECT r.*, p.* FROM adjstock r, product p WHERE (r.r_pcode = p.pcode) AND r.r_no = '" + text + "'";
        try {
    ...
    private ResultSet getRecordHeader(Calendar date1, Calendar date2) {
        String sql = "SELECT * FROM hadjstock WHERE (r_date BETWEEN '" + dateFmtSql.format(date1.getTime()) + "' AND '" + dateFmtSql.format(date2.getTime()) + "')";
        sql += " ORDER BY r_date ";
        try {
    ...
    private void cmdPrint() {
        ...
        snp.adjstockPrintReport(txt1.getText().trim(), txt2.getText().trim(),chk1.isSelected(), true);
    }
}
