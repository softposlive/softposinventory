 ...
 * @author  root
 */
public class Jdi_report_sumRecivePLU extends javax.swing.JDialog {
 
    /** Creates new form Jdi_report_recive */
    public Jdi_report_sumRecivePLU(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(txtPcode1, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
                ...
                .addComponent(txtPcode2, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0)
        ...
        tblDetail.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "วันที่ (Date)", "เลขที่เอกสาร", "คลัง", "จำนวนสั่ง", "จำนวนส่ง", "จำนวนรับ", "จำนวนเงิน", "โรงงาน", "ผู้บันทึก", "วันที่บันทึก", "เวลาบันทึก"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.String.class
            };
        ...
        tblHeader.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสสินค้า (PLU Code)", "ชื่อสินค้า/รายการ", "จำนวนสั่ง", "จำนวนส่ง", "จำนวนรับ", "หน่วยนับ", "จำนวนเงิน"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jTabbedPane1.addTab("สรุปรายการรับสินค้าตามรหัสสินค้า (รวมทั้งหมด)", jPanel4);
        ...
        tblPage2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสโรงงาน", "ชื่อโรงงาน", "รหัสสินค้า", "ชื่อสินค้า/รายการ", "จำนวนสั่ง", "จำนวนส่ง", "จำนวนรับ", "หน่วยนับ", "จำนวนเงิน", ""
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jTabbedPane1.addTab("สรุปรายการรับสินค้าตามรหัสสินค้า (แยกตามโรงงาน)", jPanel5);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTabbedPane1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 994, Short.MAX_VALUE)
...
private void cmdPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrintActionPerformed
    report.sumRecivePLU1PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
...
private void cmdPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdPrint1ActionPerformed
     report.sumRecivePLU2PrintReport(txt1.getText().trim(), txt2.getText().trim(), txtPcode1.getText().trim(), txtPcode2.getText().trim(), txtPbran1.getText().trim(), txtPbran2.getText().trim(), true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Jdi_report_sumRecivePLU dialog = new Jdi_report_sumRecivePLU(new javax.swing.JFrame(), true);
    ...
    private void setTableHeader(){
        ...
        int[] colSize = {70, 200, 70, 70, 70, 60, 100};
        tblHeader.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void setTableDetail(){
        ...
        TableColumn column = null;
        int[] colSize = {90, 80, 50, 70, 70, 70, 100, 120, 80, 80, 90};
        tblDetail.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        for (int i = 0; i < colSize.length; i++) {
    ...
    private void setTableHeaderBran(){
        ...
        TableColumn column = null;
        int[] colSize = {80, 150, 100, 250, 60, 60, 60, 50, 100, 30};
        tblPage2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        for (int i = 0; i < colSize.length; i++) {
    ...
    private ResultSet getRecordHeaderAll(Calendar date1, Calendar date2, String pcode1 , String pcode2, String pbran1,String pbran2)  {
        String sql = "SELECT TranOut.R_PCode, " +
                ...
                "TranOut.R_No, TranOut.R_Post, TranOut.R_Que, TranOut.R_Stock, HtranOut.R_No, HtranOut.R_Date, HtranOut.R_Bran ,Product.pdesc ,Product.punit1" +
                    " FROM recive TranOut left JOIN hrecive HtranOut " +
        ...
        if(rs!=null){
            ...
            try {
                while (rs.next()) {
                    ...
                    row[2] = Format.qtyFmt.format(rs.getFloat("SUM( TranOut.R_Order )"));
                    row[3] = Format.qtyFmt.format(rs.getFloat("SUM( TranOut.R_Send )"));
                    row[4] = Format.qtyFmt.format(rs.getFloat("SUM( TranOut.R_Qty )"));
    ...
    private void loadDetail(Calendar date1, Calendar date2, String pcode, String pbran1,String pbran2 ){
        ...
        String sql = "SELECT TranOut.R_No, " +
                "TranOut.R_Que, TranOut.R_PCode, " +
                "TranOut.R_Stock, TranOut.R_Pack, " +
                "TranOut.R_Order, " +
                "TranOut.R_Send, " +
                "TranOut.R_Qty, TranOut.R_Post, " +
                "TranOut.R_Unit, TranOut.R_Cost, T" +
                "ranOut.R_Amount, TranOut.R_TotalQty, " +
                "TranOut.R_User, TranOut.R_Time, " +
                "TranOut.R_EntryDate, HtranOut.R_No, " +
                "HtranOut.R_Date, HtranOut.R_Remark, " +
                "HtranOut.R_Bran, HtranOut.R_Total, HtranOut.R_User, " +
                "HtranOut.R_Post, HtranOut.R_UserPost, HtranOut.R_PostDate, " +
                "HtranOut.R_PostTime , b.factoryname" +
                " FROM recive TranOut" +
        ...
        try {
            ...
            while(rs.next()){
                ...
                row[3] = Format.qtyFmt.format(rs.getInt("r_order"));
                row[4] = Format.qtyFmt.format(rs.getInt("r_send"));
                row[5] = Format.qtyFmt.format(rs.getInt("r_qty"));
                //row[3] = "?????";
                row[6] = Format.doubleFmt.format(rs.getFloat("r_amount"));
                row[7] = rs.getString("factoryname");
                row[8] = rs.getString("r_userpost");
                row[9] = rs.getString("r_postdate");
                row[10] = rs.getString("r_posttime");
    ...
    private ResultSet getRecordHeaderBran(Calendar date1, Calendar date2, String pcode1 , String pcode2, String pbran1,String pbran2)  {
        String sql = "SELECT TranOut.R_PCode, " +
                ...
                "SUM( TranOut.R_Send ), " +
                "SUM( TranOut.R_Qty ), " +
                "SUM( TranOut.R_Amount ), TranOut.R_No, TranOut.R_Que, TranOut.R_Post, HtranOut.R_No, HtranOut.R_Date,HtranOut.R_Bran, HtranOut.R_Post ,p.pdesc,p.punit1,b.factorycode,b.factoryname" +
                    " FROM recive TranOut left JOIN hrecive HtranOut " +
                    " ON  (TranOut.R_No = HtranOut.R_No)" +
                    " left JOIN product p " +
                    " ON (TranOut.r_pcode = p.pcode)" +
                    " left JOIN factory b ON (HtranOut.R_Bran = b.factorycode) " +
                    " WHERE  (TranOut.R_Post = 'Y') and " +
                    " (HtranOut.R_Date>='"+Format.dateFmtSql.format(date1.getTime())+"') and (HtranOut.R_Date<='"+Format.dateFmtSql.format(date2.getTime())+"') and" +
                    " (TranOut.R_PCode>='"+pcode1+"') and (TranOut.R_PCode<='"+pcode2+"') and " +
